    ...
    <header className="header">
      <div className="header__left">
        <div className="header__logo">
          ...
          <h2 className="header__logo-text">Wine not</h2>
        </div>
      </div>
      ...
      <div className="header__right">
        ...
        <div className="header__actions">
          ...
          <details className="header__user-menu">
            <summary className="header__user-summary">
              <span className="button button--icon">
                <svg
            ...
            <ul className="header__dropdown">
              ...
              <li className="header__dropdown-item">
                <Link to="/registration" className="header__dropdown-link">
                  Register
                </Link>
              </li>
            </ul>
