  ...
  return (
    <Card padding="lg" className="container__dark" style={{ height: '100%' }}>
      <Stack align="center">
        ...
        <Text className="member-card__role" c={theme.colors.accent[4]} size="14px" style={{marginBottom: '0px'}}>
          {member.role}
        </Text>
        <Anchor className="member-card_github" href={member.github}>
          <Group gap="8px">
            <svg
              width="20px"
              height="20px"
            ...
            <Text c={theme.colors.primary[3]} size="14px">{member.github.substring(member.github.lastIndexOf('/') + 1)}</Text>
          </Group>
        </Anchor>
