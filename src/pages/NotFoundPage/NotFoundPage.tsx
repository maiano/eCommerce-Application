            ...
            <Container fluid className="page">
              <Box className="not-found-content">
                ...
                <Group className="header__logo" gap="xs">
                    <svg className="header__logo-icon" viewBox="0 0 48 48" fill="none" style={{ color: theme.colors.red[9] }}>
                      <path
                  ...
                  <Title className="header__logo-text" order={2}>Wine not</Title>
                </Group>

                <Group className="not-found-text">
                  <Title className="not-found-title" order={1}>404</Title>
                  <Title className="not-found-subtitle" order={2}>Page Not Found</Title>
