...
export default function ProfilePage() {
  ...
  const [selectedAddress, setSelectedAddress] = useState<BaseAddress | null>(
    null,
  );
    ...
    <Container className="page">
      <Box className="profile-container">
        ...
        <Box className="profile-section-container">
            ...
            <Group className="profile-section" justify="space-between">
              <Group>
                <Avatar
                  ...
                  name={`${user?.body.firstName?.[0]} ${user?.body.lastName}`}
                  color={theme.primaryColor}
                  variant="filled"
                  size="80px"
                  style={{
                    border: 'none',
                    '--avatar-color': theme.colors.primary[9],
                  }}
                ></Avatar>
          ...
          <Container
            className="container-dark info-section"
            style={{ marginBottom: '24px' }}
          >
            ...
            <Grid gutter="lg">
              <Grid.Col span={{ base: 12, sm: 6 }}>
                <Stack style={{ gap: 5 }}>
                  <Text c={theme.colors.primary[3]} size="14px">
                    First Name
                  </Text>
          ...
          <Container
            className="container-dark address-section"
            style={{ marginBottom: '24px' }}
          >
            <Title
              order={2}
                ...
                <Stack gap={0}>
                  <Group style={{ marginBottom: '8px' }}>
                    {user.body.shippingAddressIds?.includes(
                      ...
                      <Badge
                        style={{ '--badge-color': theme.colors.primary[9] }}
                        radius="sm"
                      >
