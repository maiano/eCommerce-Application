import { Anchor, Box, Container, Grid, Group, Image, Stack, Text, Title, useMantineTheme } from "@mantine/core";
  ...
  return(
    <Container className="page">
      <Box className="about-container">
        ...
        <Title order={3} style={{marginBottom: '24px'}}>Teamwork collaboration:</Title>
        <Grid gutter="lg" style={{ marginBottom: '36px' }}>
          <Grid.Col span={{ base: 12, sm: 3 }}>
            <Group className="team-collaboration-item">
              <svg xmlns="http://www.w3.org/2000/svg" height="32px" width="32px"><rect fill={theme.colors.primary[3]} height="32" rx="15%" width="32"/><rect height="12" rx="2" width="8" x="18" y="6"/><rect height="18" rx="2" width="8" x="6" y="6"/></svg>
              <Text c={theme.colors.primary[3]}>Kanban board with sprint planning</Text>
            </Group>
          </Grid.Col>
          <Grid.Col span={{ base: 12, sm: 3 }}>
            <Group className="team-collaboration-item">
          ...
          <Grid.Col span={{ base: 12, sm: 3 }}>
            <Group className="team-collaboration-item">
              ...
              <Text c={theme.colors.primary[3]}>Support and help of teammates</Text>
            </Group>
          </Grid.Col>
          <Grid.Col span={{ base: 12, sm: 3 }}>
            <Group className="team-collaboration-item">
              <svg width="32px" height="32px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill={theme.colors.primary[3]}  style={{ display: 'block' }}>
              ...
              <Text c={theme.colors.primary[3]}>Mutual code reviews on GitHub</Text>
            </Group>
          </Grid.Col>
        </Grid>
        <Container className="container__dark" style={{border: 'none'}}>
          <Stack align="center">
            <Title order={2} style={{marginBottom: '24px', marginTop: '24px'}}>Big thanks to:</Title>
            ...
            <Text className="rsschool-description" c={theme.colors.primary[3]} size="14px" style={{marginBottom: '24px'}}>RS School offers a unique learning experience as a free, community-based online education initiative. It has been run by the Rolling Scopes community since 2013. Today, over 600 developer-volunteers from various countries and companies assist as mentors. We believe in important ideas that guide our mission.</Text>
          </Stack>
        </Container>
      </Box>
    </Container>
